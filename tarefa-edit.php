            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                        <i class="bi bi-clipboard2-minus"></i> Editar tarefa 
                    ...
                    <div class="card-body">
                        ...
                        <form action="acoes.php" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="edit_tarefa" class="btn btn-dark float-end">Editar <i class="bi bi-clipboard2-minus"></i></button>
                            </div>
                        </form>
                        <?php
                        else:
